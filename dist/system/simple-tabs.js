...
System.register(['aurelia-framework'], function (_export, _context) {
  ...
  var inject, bindable, DOM, computedFrom, _createClass, _dec, _dec2, _dec3, _class, _desc, _value, _class2, SimpleTabs;
  ...
  return {
    ...
    execute: function () {
      ...
      _export('SimpleTabs', SimpleTabs = (_dec = inject(DOM.Element), _dec2 = computedFrom('tabsEl'), _dec3 = computedFrom('tabsEl', 'activeTabIdx'), _dec(_class = (_class2 = function () {
